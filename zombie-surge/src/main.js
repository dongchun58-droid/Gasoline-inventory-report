...
function applyTheme(t) {
  ...
  // 우주처럼 멀리까지 보여야 하는 테마는 안개 거리를 직접 정한다
  scene.fog = new THREE.Fog(t.fog, t.fogNear != null ? t.fogNear : (t.time === 'night' ? 70 : 95),
    t.fogFar != null ? t.fogFar : (t.time === 'night' ? 240 : 320));
...
const admin = new Admin({ state, scene, camera, fx, audio, hud, input, launch });
